...
namespace API.Controllers
{
    ...
    public class BlogPostController : ControllerBase
    {
        ...
        [HttpPost("{blogPostId}/comments/{commentId}")]
        public async Task<IActionResult> AddCommentToBlogPost(int blogPostId, int commentId, CancellationToken cancellationToken)
        {
